...
sizeMediaTablet(mediaTablet);mediaTablet.addListener(sizeMediaTablet);function sizeMediaPhone(mediaPhone){if(mediaPhone.matches){window.addEventListener('scroll',function(){background.style.backgroundSize=350- +window.pageYOffset/12+'%'})}}
